...
namespace Services
{
    ...
    {
        List<ApiModel> apiModelList = new List<ApiModel>();
        public List<ApiModel> GetApiDataById(int Id)
        {
           var ApiListById= apiModelData().Where(i=>i.ApplicationId==Id).ToList();
            return ApiListById;
        }

        public List<ApiModel> GetApiData()
        {
            var ApiList = apiModelData().ToList();
            return ApiList;
        }

        private ICollection<ApiModel>apiModelData()
        {
            apiModelList.Add(new ApiModel
            {
            ...
            apiModelList.Add(new ApiModel
            {
                ...
                Summary = "Payment",
                Amount = 58.39,
                PostingDate = "2016-10-01T00:00:00",
                IsCleared = true,
                ClearedDate = "2016-10-02T00:00:00"
            });
            apiModelList.Add(new ApiModel
            {
                ...
                Summary = "Payment",
                Amount = 57.55,
                PostingDate = "2016-11-01T00:00:00",
                IsCleared = true,
                ClearedDate = "2016-11-02T00:00:00"
            });
            apiModelList.Add(new ApiModel
            {
            ...
            apiModelList.Add(new ApiModel
            {
                Id = "fcd0ab16-9ccc-4a24-825b-d11c283c2d58",
                ApplicationId = 197104,
                Type = "Debit",
                Summary = "Payment",
                Amount = 59.03,
            ...
            apiModelList.Add(new ApiModel
            {
                Id = "b2874279-04e3-480e-9670-c4d4d3ed8a43",
                ApplicationId = 197104,
                Type = "Debit",
                Summary = "Payment",
                Amount = 51.51,
            ...
            apiModelList.Add(new ApiModel
            {
                Id = "fc099e30-6629-4015-a9e8-91edf442d69e",
            ...
            apiModelList.Add(new ApiModel
            {
                Id = "5f19429f-3ab8-41b1-b058-66b1ff0f46bc",
                ApplicationId = 456299,
                Type = "Debit",
                Summary = "Payment",
                Amount = 53.73,
            ...
            apiModelList.Add(new ApiModel
            {
                Id = "53f931be-6f8e-44ea-913f-051aa2cc7b6e",
                ApplicationId = 456299,
                Type = "Debit",
                Summary = "Payment",
                Amount = 52.07,
            ...
            apiModelList.Add(new ApiModel
            {
                Id = "66d28c93-3002-4816-b65c-f4777152faaa",
                ApplicationId = 456299,
                Type = "Debit",
                Summary = "Payment",
                Amount = 52.86,
            ...
            apiModelList.Add(new ApiModel
            {
                Id = "7557e1e0-6a60-495e-9e4d-df9cf6cc4c00",
                ApplicationId = 456299,
                Type = "Debit",
                Summary = "Payment",
                Amount = 53.82,
